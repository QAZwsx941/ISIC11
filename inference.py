...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--img_path', type=str, default='./dataset/train/imgs/IMG-0002-00058-crop.png')
    parser.add_argument('--model_path', type=str, default='./models/R2AttU_Net-200-0.0003-108-0.4001.pkl')
