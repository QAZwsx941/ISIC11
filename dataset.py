...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--origin_data_path', type=str, default='../ISIC/dataset/train/img-npy')
    parser.add_argument('--origin_GT_path', type=str, default='../ISIC/dataset/train/mask-npy')
